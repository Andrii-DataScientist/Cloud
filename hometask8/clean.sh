...
aws s3 rm s3://aws-sam-cli-managed-default-samclisourcebucket-i6xlmm7wfrs9 --recursive
aws s3 rb s3://aws-sam-cli-managed-default-samclisourcebucket-i6xlmm7wfrs9
